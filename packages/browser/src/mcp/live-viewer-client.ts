...
type Client = RpcClient.RpcClient<
  RpcGroup.Rpcs<typeof LiveViewerRpcs>,
  RpcClientError
>;
...
export class LiveViewerClient extends ServiceMap.Service<
  LiveViewerClient,
  Client
>()("@browser/LiveViewerClient") {
  static layer = Layer.effect(LiveViewerClient)(
    RpcClient.make(LiveViewerRpcs)
