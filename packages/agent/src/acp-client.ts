...
export class AcpStreamError extends Schema.ErrorClass<AcpStreamError>(
  "AcpStreamError"
)({
...
export class AcpClient extends ServiceMap.Service<AcpClient>()(
  "@browser-tester/AcpClient",
  {
