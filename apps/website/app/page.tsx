    ...
    <div className="[font-synthesis:none] overflow-x-clip antialiased min-h-screen bg-[color(display-p3_0.981_0.981_0.981)] flex flex-col items-center">
      ...
      <div className="relative w-full max-w-112.75 min-w-0 px-4 sm:px-0">
        <div className="flex flex-col gap-[5px] mt-13">
          <div className="w-112.75 tracking-[-0.03em] [white-space-collapse:preserve] font-['OpenRunde-Semibold','Open_Runde',system-ui,sans-serif] font-semibold text-[23px]/9.5 text-[#3c3c3c]">
            Expect
          </div>
          <div
            className="[letter-spacing:0em] w-102 [white-space-collapse:preserve] font-['OpenRunde-Medium','Open_Runde',system-ui,sans-serif] font-medium text-[17px]/[28px] text-[#707070]"
          >
            ...
            >
              ...
              {!copied && (
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  style={{ flexShrink: '0', verticalAlign: 'middle', width: '20px', height: '20px', overflow: 'clip' }}
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
          ...
          <div className="[font-synthesis:none] flex w-full min-w-0 flex-col items-stretch gap-2.5 antialiased p-0">
            <div className="flex w-full min-w-0 items-start gap-2.25">
              ...
              <div className="flex min-w-0 flex-1 flex-wrap items-center gap-x-1.5 gap-y-1.5">
                ...
                <div className="inline-flex items-center rounded-[9px] bg-[color(display-p3_0.903_0.903_0.903)] px-2.25 py-px">
                  <div
                    className="text-[#4d4d4d] font-['OpenRunde-Medium','Open_Runde',system-ui,sans-serif] font-medium text-[15px]/5.75"
                  >
                    /expect
                  </div>
                </div>
                ...
                <div className="text-[color(display-p3_0.155_0.572_1)] font-['OpenRunde-Medium','Open_Runde',system-ui,sans-serif] font-medium underline decoration-[color(display-p3_0.669_0.821_1)] decoration-2 underline-offset-[5px] text-[15px]/5.75">
                  and more
                </div>
              </div>
            </div>
      ...
      <div className="relative w-full max-w-112.75 min-w-0 px-4 sm:px-0 pb-20">
        <a
          ...
          className="group [font-synthesis:none] items-center flex justify-between mt-4 w-fit rounded-full overflow-clip gap-2.5 pl-3.25 pr-1.75 py-1.5 bg-white [box-shadow:#0000000F_0px_0px_0px_1px,#0000000F_0px_1px_2px_-1px,#0000000A_0px_2px_4px] antialiased transition-shadow hover:[box-shadow:#00000014_0px_0px_0px_1px,#00000014_0px_1px_2px_-1px,#0000000F_0px_2px_4px]"
        >
