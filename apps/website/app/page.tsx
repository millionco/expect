    ...
    <div className="[font-synthesis:none] overflow-x-clip antialiased min-h-screen bg-white flex flex-col items-center">
      ...
      <div className="relative w-112.75 pb-20">
        ...
        <div className="flex flex-col w-107.25 mt-14">
          ...
          {[
            {
              question: "How is this different from Puppeteer / Playwright / Cypress?",
              answer:
            ...
            {
              question: "How is this different from coding agents or computer-use tools?",
              answer:
            ...
            {
              question: "How does it fit into my workflow?",
              answer:
            ...
            {
              question: "Is there a cloud or enterprise version?",
            ...
            <div
              ...
              className="cursor-pointer group/faq pb-2.75"
            >
