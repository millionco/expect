...
import { categorizeChangedFiles } from "./categorize-changed-files.js";
...
const buildChangesSuggestions = (gitState: GitState | null): readonly string[] => {
...
export const getFlowSuggestions = (
  ...
  switch (context.type) {
    case "changes":
      return buildChangesSuggestions(gitState);
    case "pr":
